...
static ZXGCDQueue *mainQueue;
static ZXGCDQueue *globalQueue;
static ZXGCDQueue *highPriorityGlobalQueue;
static ZXGCDQueue *lowPriorityGlobalQueue;
static ZXGCDQueue *backgroundPriorityGlobalQueue;

@interface ZXGCDQueue ()

@property (strong, readwrite, nonatomic) dispatch_queue_t dispatchQueue;

@end

@implementation ZXGCDQueue
...
+ (void)initialize {
     ...
     */
    if (self == [ZXGCDQueue self])  {
        
        mainQueue                     = [ZXGCDQueue new];
        globalQueue                   = [ZXGCDQueue new];
        highPriorityGlobalQueue       = [ZXGCDQueue new];
        lowPriorityGlobalQueue        = [ZXGCDQueue new];
        backgroundPriorityGlobalQueue = [ZXGCDQueue new];
